 ...
 * @author Sebastian
 */
public final class VConsultas extends javax.swing.JFrame implements IConsultas {
    private JPConsultas jpc;
    ...
    public void iniciarComponentes() {
        ...
        this.jpc = new JPConsultas();
        this.jpc.setSize(500, 500);
        this.getContentPane().removeAll();
        this.getContentPane().add(this.jpc);
...
//        
//        return this.jpc.getNickName();
//        
//    }
//
//    @Override
//    public String getPass() {
//        return this.jpc.getPass();
//    }

    @Override
    public void setLblMensaje(String mensaje) {
        this.jpc.setLblMensaje(mensaje);
    }
...
//    }
    ...
    public void setGanancias(float ganancias) {
        this.jpc.setGanancias(ganancias);
    }
